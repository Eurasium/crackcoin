...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "crackcoin " + FormatFullVersion();
...
//    {"crackcoin.net", "seed.ppcoin.net"},
//    {"CRC.altcointech.net", "dnsseed.CRC.altcointech.net"},
//    {"CRC2.altcointech.net", "dnsseed.CRC2.altcointech.net"},
//    {"primeseed.muuttuja.org", "primeseed.muuttuja.org"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
//    {"crackcoin.net", "tnseed.ppcoin.net"},
//    {"primeseed.muuttuja.org", "primeseed.muuttuja.org"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. crackcoin is probably already running."), addrBind.ToString().c_str());
        else
